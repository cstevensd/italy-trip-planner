...
export const schedule: ScheduleItem[] = [
  ...
  { 
    ...
    links: [
      {
        url: 'https://easy-access.turify.net/pdf.php?pdf_file=aHR0cHM6Ly93d3cucGFuY2hvdG91cnMuY29tL2dlc3Rpb24vYXNzZXRzL2FyY2hpdm9zLXRhcmVhcy9jb21wcm9iYW50ZV85NzEzNDdfNjNfMjcxXzBfMS5wZGY/cmFuZG9tPTExMzc0ODc1&id=5730853',
      ...
      {
        url: 'https://popguide.herokuapp.com/dl/IyMjTUJDLTAwMDM1MCMjIzY2MzU4IyMj',
        text: 'Audioguide (Audrey)'
      },
      {
        url: 'https://popguide.herokuapp.com/dl/IyMjTUJFLTAwMDM1MCMjIzUwOTA0IyMj',
        text: 'Audioguide (Grace)'
      },
      {
        url: 'https://popguide.herokuapp.com/dl/IyMjTUJGLTAwMDM1MCMjIzcyMDI5IyMj',
        text: 'Audioguide (Tessy)'
      }
    ]
  },
  { 
